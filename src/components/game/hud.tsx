import { Heart, Star, Zap, Timer, Shield } from 'lucide-react';
...
export function Hud({ score, lives, timeLeft, powerUpActive = false, shieldActive = false }: HudProps) {
  return (
      ...
      <div className="flex items-center gap-4">
        ...
        {shieldActive && (
            <div className="flex items-center gap-2 text-blue-400 animate-pulse">
                <Shield className="w-5 h-5 md:w-7 md:h-7 fill-blue-400" />
                <span className="font-code text-sm hidden md:inline">SHIELD!</span>
            </div>
        )}
